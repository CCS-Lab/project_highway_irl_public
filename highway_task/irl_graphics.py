...
from irl_road_graphics import WorldSurface, RoadGraphics
#from highway_env.vehicle.graphics import VehicleGraphics
from irl_vehicle_graphics import VehicleGraphics
    ...
    def handle_events(self) -> None:
        ...
        for event in pygame.event.get():
            ...
            if self.env.action_type:
                if (time.time()-self.lateral_pressed_time)>self.env.vehicle.TAU_LATERAL+0.25:#+0.35:
                        self.lateral_pressed=False
                        self.lateral_pressed_time=0
