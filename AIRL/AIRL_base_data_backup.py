    ...
    with tf.Session(config=tf.ConfigProto(gpu_options=gpu_options)) as sess:
        ...
        for iteration in range(args.iteration):
            ...
            for i in range(args.num_parallel_sampler):
                ...
                # x1 = AIRL_test_function_gym.remote(args.envs_base, policy_value, discriminator_value,
                #                                        discrete_env_check,
                #                                        np.ceil(args.min_length / args.num_parallel_sampler),
                #                                        i, args.units_p, args.units_v, args.lr_discrim, discrim_batch_number, args.discretize,args.two_distance,args.back_distance,args.config)
