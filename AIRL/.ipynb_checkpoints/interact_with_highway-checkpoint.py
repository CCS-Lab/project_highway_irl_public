...
def AIRL_test_function_gym(args, network_policy_values, network_discrim_values, discrete_env_check, EPISODE_LENGTH,
    ...
    if args.envs_base == "Highway":
        ...
        if args.version == 1:
            import highway_irl
            from behavior.irl_graphics import EnvViewer2
            env = gym.make('IRL-v1')       
    ...
    if args.two_distance or args.back_distance:
        n_feature = 11
    else:
        n_feature = 8
    ...
    with tf.Session() as sess:
        ...
        while True:
            ...
            state,lane_speed = transform_obs(obs_a,lane_speed,args.discretize,args.two_distance,args.back_distance,max_speed)
            ...
            if discrete_env_check:
                ...
                state_d,lane_speed_d = transform_obs(obs_discrete,lane_speed_d,args.discretize,args.two_distance,args.back_distance,max_speed)
            ...
            if episode_length >= EPISODE_LENGTH:
                next_state,lane_speed = transform_obs(next_obs,lane_speed,args.discretize,args.two_distance,args.back_distance,max_speed)
